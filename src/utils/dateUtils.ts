...
export class DateUtils {
     ...
     */
     public static parseTime(arg: string): number {
     ...
     */
    public static humanizeDate(date: Date, format: string = '%d/%mo/%y at %h/%m/%s'): string {
     ...
     */
    public static humanizeMillisTime(millis: number, format: string = '%d days, %h hours, %m minutes and %s secondes'): string {
